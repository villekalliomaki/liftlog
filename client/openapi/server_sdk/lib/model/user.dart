...
class User {
  ...
  @override
  String toString() => 'User[changed=$changed, created=$created, id=$id, username=$username]';

  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
      json[r'changed'] = this.changed.toUtc().toIso8601String();
  ...
  static User? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return User(
        changed: mapDateTime(json, r'changed', r'')!,
